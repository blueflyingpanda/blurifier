...
server_address = ("127.0.0.1", 6380)  # Use a different port to avoid conflicts with any real Redis server
...
CELERY_TASK_ALWAYS_EAGER = True  # execute synchronously in the same process instead of being sent to a worker
